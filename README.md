...
- <a href="https://github.com/myejin/Design_Pattern/blob/main/%ED%8C%A9%ED%86%A0%EB%A6%AC/abstract_factory.py">`추상 팩토리 - 피자공장`</a>
    - 팩토리 메소드가 인스턴스 생성을 서브클래스에게 맡긴다.
    - 반면, 추상 팩토리 메소드는 관련 객체의 집합을 생성한다. 또한 상속이 아닌 컴포지션을 사용한다.
<img width="800" src="https://user-images.githubusercontent.com/42771578/144778513-77ab1bd1-60af-4fba-a536-dc70cbe6d967.png">

&nbsp;

## 퍼사드

- 복잡한 내부 시스템 로직을 감추고 클라이언트에게 간소화된 인터페이스를 제공한다.
- 단일 인터페이스 객체는 서브시스템을 캡슐화하는 것이 아니라 모든 서브시스템들을 결합한다. 
